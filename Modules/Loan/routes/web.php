...
Route::middleware([
    ...
    Route::prefix('admin')->middleware(['except.user'])->group(function () {
        ...
        Route::put('loan-packages/{loanPackage}/status', [LoanPackageController::class, 'updateStatus'])->name('admin.loan-packages.update-status');
        Route::get('loan-packages.all', [LoanPackageController::class, 'getAllLoans'])->name('admin.loan-packages.all');
        Route::post('loan-packages.export', [LoanPackageController::class, 'export'])->name('admin.loan-packages.export');
        Route::post('loan-packages.bulk-delete', [LoanPackageController::class, 'bulkDelete'])->name('admin.loan-packages.bulk-delete');
        Route::post('loan-packages.bulk-archive', [LoanPackageController::class, 'bulkArchive'])->name('admin.loan-packages.bulk-archive');

        // Loan routes
        Route::resource('loans', LoanController::class);
        Route::put('loans/{loan}/status', [LoanController::class, 'updateStatus'])->name('admin.loans.update-status');
        Route::get('loans.all', [LoanController::class, 'getAllLoans'])->name('admin.loans.all');
        Route::post('loans.export', [LoanController::class, 'export'])->name('admin.loans.export');
        Route::post('loans.bulk-delete', [LoanController::class, 'bulkDelete'])->name('admin.loans.bulk-delete');
        Route::post('loans.bulk-archive', [LoanController::class, 'bulkArchive'])->name('admin.loans.bulk-archive');
