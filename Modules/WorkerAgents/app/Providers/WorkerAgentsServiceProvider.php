...
namespace Modules\WorkerAgents\Providers;
...
class WorkerAgentsServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'WorkerAgents';

    protected string $nameLower = 'workeragents';
