...
//                'vendor/laravel/framework/src/Illuminate/Session', // Exclude sessions queries
            ...
            'duration_background'  => true,   // Show shaded background on each query relative to how long the query took.
    ...
    /*
     |--------------------------------------------------------------------------
     | DebugBar route excluded paths
     |--------------------------------------------------------------------------
     |
     | The DebugBar route excluded paths
     |
     */
    'route_excluded_paths' => [
        'api/*',
        'tenant/*',
        'debugbar/*',
    ],
