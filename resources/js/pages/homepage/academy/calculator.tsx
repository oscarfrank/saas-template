                ...
                <main className="pt-24 pb-20">
                    <section className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl text-center">
                            <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-teal-100 text-teal-600">
                            ...
                            <p className="mt-4 text-slate-600">
                                Study planners, course time estimators, and more. Coming soon.
                            </p>
                            <Button
                                asChild
                                variant="outline"
                                className="mt-8 rounded-xl border-teal-200 text-teal-700 hover:bg-teal-50"
                            >
