...
export function Footer() {
    ...
    return (
        <footer
            className="border-t border-teal-100 bg-teal-50/50 py-12 md:py-16"
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2 text-sm text-slate-600">
                        ...
                        <Link href="/contact" className="transition-colors hover:text-teal-600">Contact</Link>
                        <Link href="/faq" className="transition-colors hover:text-teal-600">FAQ</Link>
                        <Link href="/privacy" className="transition-colors hover:text-teal-600">Privacy</Link>
                        <a
                            href={`mailto:${siteSettings.company_email}`}
                            className="inline-flex items-center gap-1.5 transition-colors hover:text-teal-600"
                        >
                ...
                {siteSettings.footer_text && (
                    <div className="mt-10 border-t border-teal-100 pt-8 text-center text-sm text-slate-500">
