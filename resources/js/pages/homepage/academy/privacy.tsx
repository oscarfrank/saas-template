                        ...
                        <div className="mx-auto max-w-3xl">
                            ...
                            <div className="mt-8 space-y-6 text-slate-600">
                                <p className="leading-relaxed">
                                    {siteSettings.site_name} respects your privacy. We collect only what we need to provide and improve our learning platform—account details, progress data, and usage related to courses—and we don’t sell your data.
                                </p>
                                <p className="leading-relaxed">
                                    For questions or to exercise your rights, contact us at{' '}
                                    <a href={`mailto:${siteSettings.company_email}`} className="text-teal-600 font-medium hover:underline">
