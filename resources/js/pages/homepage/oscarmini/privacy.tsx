                        ...
                        <div className="mx-auto max-w-3xl">
                            ...
                            <div className="mt-8 space-y-6 text-slate-600">
                                <p className="leading-relaxed">
                                    {siteSettings.site_name} respects your privacy. We collect only what we need to provide and improve our services—staff management, studio, payroll, assets, loans, and projects—and we don’t sell your data.
                                </p>
                                <p className="leading-relaxed">
                                    For questions or to exercise your rights, contact us at{' '}
                                    <a href={`mailto:${siteSettings.company_email}`} className="text-slate-900 font-medium hover:underline">
