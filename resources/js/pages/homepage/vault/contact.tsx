                    ...
                    <section className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-xl">
                            ...
                            <p className="mt-4 text-slate-400">
                                Questions about your membership, billing, or tiers? We’re here.
                            </p>
                            ...
                            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        className="mt-2 rounded-xl border-white/10 bg-white/[0.04] text-white placeholder:text-slate-500 focus-visible:ring-amber-500/50"
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={handleChange}
                                        className="mt-2 min-h-[140px] rounded-xl border-white/10 bg-white/[0.04] text-white placeholder:text-slate-500 focus-visible:ring-amber-500/50"
                                ...
                                <Button
                                    type="submit"
                                    className="w-full rounded-xl bg-amber-500 font-semibold text-slate-900 shadow-lg shadow-amber-500/25 hover:bg-amber-400 sm:w-auto sm:px-8"
                                >
                                    Send message
                                </Button>
                            </form>
