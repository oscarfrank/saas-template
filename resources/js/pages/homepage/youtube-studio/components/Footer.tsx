...
export function Footer() {
    ...
    return (
        <footer
            className="border-t border-white/[0.06] bg-neutral-950 py-12 md:py-16"
        ...
        >
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-10 border-t border-white/[0.06] pt-8 text-center text-sm text-neutral-600">
