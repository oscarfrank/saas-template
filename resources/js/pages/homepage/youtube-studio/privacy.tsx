                ...
                <main className="pt-24 pb-20">
                    <section className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-3xl">
                            ...
                            <div className="mt-8 space-y-6 text-neutral-400">
                                <p className="leading-relaxed">
                                    {siteSettings.site_name} respects your privacy. We collect only what we need to provide and improve our studio management services—scripts, shoots, tasks, and payroll—and we don’t sell your data.
                                </p>
                                <p className="leading-relaxed">
