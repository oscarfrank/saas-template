                    ...
                    <Card className="p-6">
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-muted-foreground">Submitted details</p>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="font-medium">{kycVerification.phone_number}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm text-muted-foreground">Email</p>
                                        <p className="font-medium">{kycVerification.user.email}</p>
                                    </div>
                                </div>
