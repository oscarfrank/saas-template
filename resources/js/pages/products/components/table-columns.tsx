    ...
    return [
        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <Link 
                        href={tenantRouter.route('products.show', { product: product.id })}
    ...
    // Adding Actions Columns

        {
            ...
            cell: ({ row }) => {
                ...
                const handleShare = () => {
                    const url = tenantRouter.route('products.show', { product: product.id });
                ...
                const handleDelete = () => {
                    setIsDeleting(true);
                    router.delete(tenantRouter.route('products.destroy', { id: product.id }), {
                        preserveState: true,
                        preserveScroll: true,
                        onSuccess: () => {
                ...
                return (
                    <div className="flex items-center gap-2">
                        <Link href={tenantRouter.route('products.show', { product: product.id })}>
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                <DropdownMenuItem asChild>
                                    <Link href={tenantRouter.route('products.edit', { product: product.id })} className="cursor-pointer">
